...
internal class Program
{
    private static async Task Main(string[] args)
    {
        ...
        await repository.AddGroupIfNotExistAsync(@"ИС-41");
        await repository.AddGroupIfNotExistAsync(@"ИС-42");
        await repository.AddGroupIfNotExistAsync(@"ИС-31");
        await repository.AddGroupIfNotExistAsync(@"ИС-32");
